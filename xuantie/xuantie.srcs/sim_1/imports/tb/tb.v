...
module tb();
  ...
  integer i;
  reg [31:0] mem_inst_temp [65535:0];
  reg [31:0] mem_data_temp [65535:0];
  integer j;
  initial
  begin
    ...
    $readmemh("/home/siriux/A00XuanTie-C910-FPGA/smart_run/work/inst.pat", mem_inst_temp);
    $readmemh("/home/siriux/A00XuanTie-C910-FPGA/smart_run/work/data.pat", mem_data_temp);
